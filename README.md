...
| `opencode-api-key`           | No       | —                     | Used when the main or aux model names `opencode`/`opencode-go`; accepts a comma-separated list and each run picks the key with the most weekly Go-plan allowance left                                                                                                                                                                                                 |
